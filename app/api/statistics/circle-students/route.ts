...
import { countStudyDaysInRange, getDateRange, getStudyDatesInRange, getStudyWeekEnd, getStudyWeekStart, isStudyDay, type CustomDateRange, type DateFilter } from "@/lib/study-calendar"
...
export async function GET(request: NextRequest) {
  try {
    ...
    const studyDates = getStudyDatesInRange(filter === "all" ? activeSemesterStartDate ?? start : effectiveStart, end, formatDateForQuery)
